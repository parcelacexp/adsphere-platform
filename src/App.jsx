    ...
    <div className="site">
      ...
      <main>
        ...
        <section className="section" id="parcelace">
          ...
          <p>
            ParcelAce Express is the operational logistics arm of the broader AdSphere
            system, providing last-mile sorting and delivery support as the execution
            layer of digital commerce participation.
          </p>
        </section>
        ...
        <section className="section" id="impact">
          ...
          <div className="grid">
            ...
            <div className="card">
              ...
              <p>
                Create clearer pathways for creators and individuals to participate in
                digital commerce.
              </p>
            </div>
            <div className="card">
