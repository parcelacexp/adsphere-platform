    ...
    <>
      <section className="hero page-wrap">
        <div className="hero-copy">
          ...
          <h1>Helping small businesses, merchants, and creators enter digital commerce.</h1>
          <p className="hero-subtitle">
            AI-powered matching, product understanding, and structured collaboration — connected to real-world execution through ParcelAce Express.
          </p>
          <div className="button-row">
            <button className="btn btn-primary" onClick={() => setPage('platform')}>Explore Platform</button>
            <button className="btn btn-secondary" onClick={() => setPage('parcelace')}>Learn About Our Infrastructure</button>
          </div>
          <div className="stat-grid">
            {[['SMBs','Supported'],['AI','Matching Logic'],['Creators','Enabled'],['Logistics','Execution Layer']].map(([value,label]) => (
      ...
      <section className="page-wrap section-space">
        ...
        <div className="card-grid three">
          {[
            ...
            <div className="feature-card" key={text}><p>{text}</p></div>
          ))}
        </div>
      </section>
      ...
      <section className="page-wrap section-space">
        <div className="glass-panel centered-panel">
          ...
          <p className="centered-copy">We bridge digital decision-making with real-world execution, creating a more complete infrastructure for market entry and digital trade participation.</p>
        </div>
      </section>
    </>
  );
...
function AboutPage() {
  return (
    <section className="page-wrap section-space">
      <SectionHeader eyebrow="About" title="A broader infrastructure system for digital commerce participation." body="AdShpere is designed to help small and medium-sized businesses, independent merchants, and emerging creators access digital commerce opportunities with lower friction and more structured support." />
      <div className="card-grid two top-gap">
        <div className="feature-card large-card">
          ...
          <p>AdShpere is intended to function as a technology-enabled commercial infrastructure system. Rather than simply increasing visibility, it is designed to improve how users identify suitable opportunities, evaluate products remotely, and organize collaboration more effectively.</p>
          <p>Its purpose is to lower barriers to market entry for smaller participants who often lack the internal systems, networks, or operational support needed to navigate fast-moving digital commerce environments.</p>
        </div>
        <div className="feature-card large-card">
          <div className="eyebrow small">Why It Matters</div>
          <h3>Built for access, efficiency, and scalability.</h3>
          <p>Many smaller businesses and individual operators can see the opportunity in digital commerce, but they still face fragmented workflows, weak matching quality, and high coordination costs. AdShpere is designed to help close that gap.</p>
          <p>Over time, the system is intended to support broader digital trade participation by making opportunity discovery, product evaluation, and collaboration more navigable and more consistent.</p>
        </div>
      </div>
    </section>
  );
...
function PlatformPage() {
  return (
    <section className="page-wrap section-space">
      <SectionHeader eyebrow="Platform" title="Designed to reduce cost, improve fit, and organize execution." body="AdShpere combines decision support, product understanding, and workflow structure into a more coherent path from market entry to commercial action." />
      <div className="card-grid two top-gap">
        {[
...
function ParcelAcePage() {
  return (
    <section className="page-wrap section-space">
      <SectionHeader eyebrow="ParcelAce Express" title="The execution layer of the broader AdShpere system." body="ParcelAce Express provides logistics and fulfillment services, including last-mile sorting and delivery support, and reflects the practical operational side of the broader digital commerce infrastructure model." />
      <div className="card-grid two top-gap special-layout">
        <div className="feature-card large-card">
          ...
          <p>ParcelAce Express focuses on parcel sorting, last-mile delivery, and fulfillment-related operational support. Its role is important because digital commerce decisions ultimately require dependable real-world execution.</p>
          <p>Within the AdShpere narrative, ParcelAce helps demonstrate that the broader vision is connected to actual commercial operations rather than remaining purely conceptual.</p>
        </div>
        <div className="card-grid three nested-grid">
          {[
            ...
            <div className="feature-card" key={title}><h3>{title}</h3><p>{text}</p></div>
          ))}
        </div>
      </div>
    </section>
...
function ImpactPage() {
  return (
    <section className="page-wrap section-space">
      <SectionHeader eyebrow="Impact" title="Lowering barriers to market participation in the digital economy." body="AdShpere is intended to help smaller businesses and new market participants access digital commerce opportunities more effectively while improving efficiency across the broader ecosystem." />
      <div className="card-grid three top-gap">
        {[
          ...
          <div className="feature-card large-card" key={title}><h3>{title}</h3><p>{text}</p></div>
        ))}
      </div>
    </section>
  );
...
function FounderPage() {
  return (
    <section className="page-wrap section-space">
      <SectionHeader eyebrow="Founder" title="Wenqian Shao" body="A digital commerce professional working at the intersection of creator-led commerce, operational execution, and system-level design thinking." />
      <div className="card-grid two top-gap">
        <div className="feature-card large-card">
          <div className="eyebrow small">Background</div>
          <p>Wenqian’s experience includes creator-led e-commerce, product selection, campaign execution, and multi-party commercial coordination. This operational foundation informs AdShpere’s focus on making digital commerce participation more practical and more structured.</p>
        </div>
        <div className="feature-card large-card">
          <div className="eyebrow small">Design Approach</div>
          <p>Her background in Instructional Technology and Media supports a systems-oriented design approach centered on how users understand information, make decisions, and navigate complex digital environments. This perspective is reflected in AdShpere’s emphasis on usability, clarity, and structured workflows.</p>
          <div className="button-row top-gap-small">
            <a className="btn btn-primary" href="mailto:hello@adsphere.com">Contact Us</a>
    ...
    <div className="site-shell">
      ...
      <header className="site-header">
        <div className="page-wrap header-inner">
          ...
          <button className="contact-button" onClick={() => setPage('founder')}>Contact</button>
        </div>
      </header>
      ...
      <footer className="site-footer">
        <div className="page-wrap footer-inner">
          <div>
            ...
            <div className="footer-copy">AI-enabled virtual trade and digital commerce collaboration infrastructure.</div>
          </div>
          <div className="footer-links">
            {NAV_ITEMS.map(([key, label]) => (
              <button key={key} onClick={() => setPage(key)}>{label}</button>
            ))}
          </div>
        </div>
      </footer>
